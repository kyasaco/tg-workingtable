/**
 * https://lpeg.info/html/js/caleandar.js
 */
/*
	Author: Jack Ducasse;
	Version: 0.1.0;
...
this.Today = new Date(param.get('today'));
...
function createCalendar(calendar, element, adjuster){
	...
	function AddDays(){
		...
		if(cnt%7==0)
		{
			day.className += "cld-day prevMonth sat";
			day.innerHTML+= '<style>.cld-day.prevMonth.sat{background-color:#95eaea;}</style>';
		}
		else if((cnt-1)%7==0)
		{
			day.className += "cld-day prevMonth sun";
			day.innerHTML+= '<style>.cld-day.prevMonth.sun{background-color:#ff8080;}</style>';
		}
			//Disabled Days
			var d = i%7;
	...
	cnt++;
		...
		else if((cnt-1)%7==0)
		{
			...
			day.innerHTML+= '<style>.cld-day.currMonth.sun{background-color:#ff8080;}</style>';
		}
		...
		if(cnt%7==0 )
		{
			day.className += "cld-day nextMonth sat";
			day.innerHTML+= '<style>.cld-day.nextMonth.sat{background-color:#95eaea;}</style>';
		}
		else if((cnt-1)%7==0)
		{
			day.className += "cld-day nextMonth sun";
			day.innerHTML+= '<style>.cld-day.nextMonth.sun{background-color:#ff8080;}</style>';
		}
...
//el=caleandarのid/data=events{DATE:,Title,link,}
